...
const file_command_1 = __webpack_require__(24);
const utils_1 = __webpack_require__(4);
const os = __importStar(__webpack_require__(3));
const path = __importStar(__webpack_require__(22));
/**
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __webpack_require__(14)("follow-redirects");
    }
    catch (error) { /* */ }
...
axios.VERSION = __webpack_require__(5).version;
...
const debug = __webpack_require__(14)('slack-message');
const util = __webpack_require__(11);
...
module.exports = async function slackNotify() {
  try {
    ...
    "production" !== 'production' && assert(false, err); // eslint-disable-line no-unused-expressions
  }
};
